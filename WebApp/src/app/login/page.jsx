    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#FFDEE9] to-[#B5FFF5] p-6">
            <div className="flex flex-col md:flex-row bg-white shadow-2xl rounded-3xl overflow-hidden w-full max-w-4xl">
                ...
                {/* Image Section */}
                <div className="hidden md:block md:w-1/2 bg-cover bg-center relative" style={{ backgroundImage: "url('\login1.jpeg')" }}>
                    <div className="absolute inset-0 opacity-20 rounded-l-3xl"></div>
                </div>
                ...
                <div className="p-8 md:w-1/2 flex flex-col justify-center items-center space-y-6">
                    ...
                    <p className="text-gray-600 text-center mb-4 text-lg">Log in to your BloodLink account and continue saving lives.</p>
                    ...
                    <p className="text-gray-600 text-sm text-center mt-4">
                        Don't have an account? <a href="/signup" className="text-[#FF4B4B] font-medium hover:underline">Sign up</a>
                    </p>
                </div>
            </div>
        </div>
